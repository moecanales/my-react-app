    ...
    "storyboard": [
        {
            ...
            "companies": {
                ...
                "bo": { "treasury": 20, "track": 3, "price": 25, "stockPrice": 25, "parValue": 25, "playerShares": 0, "baronShares": 0, "income": 0, "maxShares": 1 },
        ...
        },
        {
            ...
            "focusUI": ["company-card-bo", "stock-track-25"],
            "focusMinor": ["company-card-prr", "company-card-nyc"],
            "highlightStats": true,
            "trigger": { "type": "onStockBought", "target": "bo" },
            "nodes": [
                { "id": 0, "c": 0, "r": 3, "type": "start", "subType": "start", "name": "Seattle", "value": 5, "revealed": true },
                { "id": 1, "c": 0, "r": 5, "type": "start", "subType": "start", "name": "Portland", "value": 5, "revealed": true },
                { "id": 2, "c": 0, "r": 7, "type": "start", "subType": "start", "name": "San Francisco", "value": 5, "revealed": true },
        ...
        },
        {
            ...
            "focusNodes": [0, 28],
            "modalAnchor": "right-center",
            "arrowTarget": { "x": 355, "y": 405 },
            "trigger": { "type": "clickNext", "target": "" },
            "nodes": [
                { "id": 0, "c": 0, "r": 3, "type": "start", "subType": "start", "name": "Seattle", "value": 5, "revealed": true },
                { "id": 1, "c": 0, "r": 5, "type": "start", "subType": "start", "name": "Portland", "value": 5, "revealed": true },
        ...
        },
        {
            ...
            "belt": ["blue", "blue", "green", "green", "green"],
            "beltLabels": ["E", "S", "A", "B", "D"],
            "dialogue": "[The Baron]: Excellent. Great Northern now has the capital to expand East towards Chicago. But laying track requires materials. Look at the Conveyor Belt. To build, you must consume the first card in the queue. Click the rail icon on GN, then click the gray Standard City to the right of Chicago to build your first segment.",
            "modalAnchor": "right-center",
        ...
        },
        {
            ...
            "companies": {
                ...
                "bo": { "treasury": 32, "track": 2, "price": 30, "playerShares": 1, "baronShares": 0, "income": 15, "maxShares": 1 },
            ...
            "modalAnchor": "right-center",
            "focusUI": ["player-cash-pill", "player-networth-pill", "company-card-bo", "belt-slot-0"],
            "focusNodes": [10, 28],
            "nodes": [
                { "id": 0, "c": 0, "r": 3, "type": "start", "subType": "start", "name": "Seattle", "value": 5, "revealed": true },
                { "id": 1, "c": 0, "r": 5, "type": "start", "subType": "start", "name": "Portland", "value": 5, "revealed": true },
        ...
        },
        {
            ...
            "trigger": { "type": "onStockBought", "target": "bo" },
            "modalAnchor": "right-center",
            "focusUI": ["company-card-bo", "stock-track-20", "steel-dashboard-container"],
            "focusNodes": [10, 13],
            "nodes": [
                { "id": 0, "c": 0, "r": 3, "type": "start", "subType": "start", "name": "Seattle", "value": 5, "revealed": true },
                { "id": 1, "c": 0, "r": 5, "type": "start", "subType": "start", "name": "Portland", "value": 5, "revealed": true },
        ...
        },
        {
            ...
            "companies": {
                "prr": { "treasury": 45, "track": 1, "price": 30, "playerShares": 0, "baronShares": 0, "income": 0, "maxShares": 0 },
                "bo": { "treasury": 51, "track": 1, "price": 20, "playerShares": 2, "baronShares": 0, "income": 0, "maxShares": 3 },
                "nyc": { "treasury": 0, "track": 0, "price": 20, "playerShares": 0, "baronShares": 0, "income": 0, "maxShares": 2 }
            },
            "belt": ["red", "blue", "blue", "blue", "green"],
            "beltLabels": ["C", "I", "E", "S", "D"],
            ...
            "modalAnchor": "right-center",
            "focusUI": ["company-card-bo", "steel-dashboard-container"],
            "focusNodes": [10, 13],
            "arrowTarget": { "x": 635, "y": 405 },
            "nodes": [
                { "id": 0, "c": 0, "r": 3, "type": "start", "subType": "start", "name": "Seattle", "value": 5, "revealed": true },
                { "id": 1, "c": 0, "r": 5, "type": "start", "subType": "start", "name": "Portland", "value": 5, "revealed": true },
                { "id": 2, "c": 0, "r": 7, "type": "start", "subType": "start", "name": "San Francisco", "value": 5, "revealed": true },
        ...
        },
        {
            ...
            "modalAnchor": "right-center",
            "focusUI": ["company-card-bo", "company-card-prr", "steel-dashboard-container"],
            "focusNodes": [13, 15],
            "arrowTarget": { "x": 735, "y": 405 },
            "nodes": [
                { "id": 0, "c": 0, "r": 3, "type": "start", "subType": "start", "name": "Seattle", "value": 5, "revealed": true },
                { "id": 1, "c": 0, "r": 5, "type": "start", "subType": "start", "name": "Portland", "value": 5, "revealed": true },
                { "id": 2, "c": 0, "r": 7, "type": "start", "subType": "start", "name": "San Francisco", "value": 5, "revealed": true },
        ...
        },
        {
            ...
            "companies": {
                "prr": { "treasury": 45, "track": 1, "price": 25, "playerShares": 0, "baronShares": 0, "income": 0, "maxShares": 1 },
            ...
            "modalAnchor": "right-center",
            "focusUI": ["company-card-prr", "company-card-nyc", "company-card-bo", "steel-dashboard-container"],
            "focusNodes": [2],
            "nodes": [
                { "id": 0, "c": 0, "r": 3, "type": "start", "subType": "start", "name": "Seattle", "value": 5, "revealed": true },
                { "id": 1, "c": 0, "r": 5, "type": "start", "subType": "start", "name": "Portland", "value": 5, "revealed": true },
        ...
        },
        {
            ...
            "companies": {
                "prr": { "treasury": 70, "track": 1, "price": 25, "playerShares": 1, "baronShares": 0, "income": 0, "maxShares": 1 },
                "bo": { "treasury": 0, "track": 1, "price": 15, "playerShares": 2, "baronShares": 0, "income": 0, "maxShares": 4 },
                "nyc": { "treasury": 0, "track": 0, "price": 15, "playerShares": 0, "baronShares": 0, "income": 0, "maxShares": 3 }
            },
            "belt": ["red", "red", "red", "red", "blue"],
            ...
            "locks": { "endYear": true, "buyStock": true, "buildTrack": false },
            "modalAnchor": "right-center",
            "focusUI": ["company-card-prr", "steel-dashboard-container"],
            "focusNodes": [2, 29],
        ...
        },
        {
            ...
            "companies": {
                "prr": { "treasury": 54, "track": 3, "price": 25, "playerShares": 1, "baronShares": 0, "income": 0, "maxShares": 1 },
                "bo": { "treasury": 0, "track": 1, "price": 15, "playerShares": 2, "baronShares": 0, "income": 0, "maxShares": 4 },
                "nyc": { "treasury": 0, "track": 0, "price": 15, "playerShares": 0, "baronShares": 0, "income": 0, "maxShares": 3 }
            },
        ...
        },
        {
            ...
            "companies": {
                "prr": { "treasury": 37, "track": 3, "price": 25, "playerShares": 1, "baronShares": 0, "income": 0, "maxShares": 1 },
        ...
        },
        {
            ...
            "locks": { "endYear": true, "buyStock": true, "buildTrack": false },
            "modalAnchor": "right-center",
            "focusUI": ["company-card-nyc", "steel-dashboard-container"],
            "focusNodes": [1, 19],
