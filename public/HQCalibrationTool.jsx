...
export const HQCalibrationTool = () => {
  ...
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, zIndex: 99999, pointerEvents: 'none', width: '100%', height: '100%' }}>
      ...
      <div style={{ position: 'fixed', top: '20px', left: '80px', backgroundColor: 'rgba(15, 23, 42, 0.95)', color: 'white', padding: '15px', borderRadius: '8px', pointerEvents: 'auto', border: '2px solid #334155', boxShadow: '0 10px 25px rgba(0,0,0,0.5)', width: '300px' }}>
